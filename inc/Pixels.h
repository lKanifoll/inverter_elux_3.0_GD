...
protected:
    ...
    bool scrollSupported;
    bool scrollEnabled;

    int16_t currentScroll;
    int16_t flipScroll;
    bool scrollCleanMode;

    void printString(int16_t xx, int16_t yy, char* text, bool clean, int8_t kerning[] = NULL);
    ...
    virtual void drawCircleAntialiaced(int16_t x, int16_t y, int16_t radius, bool bordermode);
    ...
    virtual void drawRoundRectangleAntialiased(int16_t x, int16_t y, int16_t width, int16_t height, int16_t rx, int16_t ry, bool bordermode);

    int16_t* loadFileBytes(char*);
...
public:
     ...
     * @param enable a bool value that determines whether the antialiasing should be enabled or not
     */
     ...
     * @return a bool value that shows whether the antialiasing is be enabled or not
     */
     ...
     * @param enable a bool value that determines whether the scroll feature should be enabled or not
     * @see scroll(int16_t,int8_t)
     */
    inline void enableScroll(bool enable) {
        scrollEnabled = enable;
    }
    /**
     * @returns <i>true</i> if the target device can scroll and the scroll feature is enabled.
     * @see scroll(int16_t,int8_t)
     * @see enableScroll(bool)
     */
    inline bool canScroll() {
     ...
     */
    int8_t drawBitmap(int16_t x, int16_t y, int16_t width, int16_t height, uint16_t* data);
    /**
     * Draws specified bitmap image.
     * The image is drawn with its top-left corner at
     * (<i>x</i>,&nbsp;<i>y</i>) in the current coordinate
     ...
     */
    int8_t drawCompressedBitmap(int16_t x, int16_t y, const uint8_t* data);
		int8_t sizeCompressedBitmap(int16_t& width, int16_t& height, const uint8_t* data);
     ...
     * @see      drawBitmap(int16_t,int16_t,int16_t,int16_t,int[])
     */
    int8_t loadBitmap(int16_t x, int16_t y, int16_t width, int16_t height, char* path);
    /**
     * Under construction
     */
     ...
     */
    void print(int16_t xx, int16_t yy, char* text, int8_t kerning[] = NULL);
    /**
     ...
     */
    void cleanText(int16_t xx, int16_t yy, char* text, int8_t kerning[] = NULL);
    /**
     ...
     * @return text baseline offset
     */
    int16_t getTextWidth(char* text, int8_t kerning[] = NULL);
};
...
public:
    BitStream (const uint8_t* src_buffer, size_t byte_size, int8_t offset = 0) {
        bitpos = offset;
        data = src_buffer;
